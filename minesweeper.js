  ...
  var update = function (input) {
      return function (gs) {
          if (input instanceof NoClick) {
              return new Data_Tuple.Tuple(input, gs);
          };
          if (input instanceof LeftButton) {
              var ty = Data_Int.floor(input.value1 / pieceSize);
              var tx = Data_Int.floor(input.value0 / pieceSize);
              var n = tx + (ty * gs.boardWidth | 0) | 0;
              var nBoard = Data_Function.apply(Partial_Unsafe.unsafePartial)(function (dictPartial) {
                  return Data_Function.apply(Data_Maybe.fromJust(dictPartial))(Data_List.modifyAt(n)(function (p) {
                      var $22 = {};
                      for (var $23 in p) {
                          if (p.hasOwnProperty($23)) {
                              $22[$23] = p[$23];
                          };
                      };
                      $22.pieceType = Mine.value;
                      return $22;
                  })(gs.board));
              });
          ...
          throw new Error("Failed pattern match at Main line 107, column 5 - line 115, column 42: " + [ input.constructor.name ]);
      };
  };
                  ...
                  return function (board) {
                      var isMine = function (x1) {
                          return function (y1) {
                              ...
                              throw new Error("Failed pattern match at Main line 100, column 17 - line 103, column 87: " + [ x1.constructor.name, y1.constructor.name ]);
                          };
                      };
                      var count = function (dx) {
                          return function (dy) {
                              return function (c) {
                                  var $36 = isMine(x + dx | 0)(y + dy | 0);
                                  if ($36 instanceof Data_Maybe.Just) {
                                      ...
                                      throw new Error("Failed pattern match at Main line 96, column 35 - line 96, column 57: " + [ $36.value0.constructor.name ]);
                                  };
                                  if ($36 instanceof Data_Maybe.Nothing) {
                                      return c;
                                  };
                                  throw new Error("Failed pattern match at Main line 95, column 21 - line 97, column 37: " + [ $36.constructor.name ]);
                              };
                          };
                      };
                      var countMines = function ($68) {
                          return (function ($69) {
                              return (function ($70) {
                                  return (function ($71) {
                                      return count(1)(1)(count(0)(1)($71));
                                  })(count(-1)(1)(count(1)(0)($70)));
                              })(count(-1)(0)(count(1)(-1)($69)));
                          })(count(0)(-1)(count(-1)(-1)($68)));
                      };
                      return countMines(0);
                  };
              };
          ...
          var numberBoard = function (board) {
              return Partial_Unsafe.unsafePartial(function (dictPartial) {
                  return Data_Functor.mapFlipped(Data_List.functorList)(Control_Apply.apply(Data_List.applyList)(Data_Functor.map(Data_List.functorList)(Data_Tuple.Tuple.create)(Data_List.range(0)(h - 1)))(Data_List.range(0)(w - 1)))(function (v) {
                      ...
                      var $40 = Data_Eq.notEq(pieceEq)(p.pieceType)(Mine.value);
                      if ($40) {
                          var $41 = ns > 0;
                          if ($41) {
                              var $42 = {};
                              for (var $43 in p) {
                                  if (p.hasOwnProperty($43)) {
                                      $42[$43] = p[$43];
                                  };
                              };
                              $42.pieceType = new Numbered(ns);
                              return $42;
                          };
                          if (!$41) {
                              var $44 = {};
                              ...
                              $44.pieceType = Empty.value;
                              return $44;
                          };
                          throw new Error("Failed pattern match at Main line 74, column 21 - line 77, column 48: " + [ $41.constructor.name ]);
                      };
                      if (!$40) {
                          return p;
                      };
                      throw new Error("Failed pattern match at Main line 73, column 20 - line 78, column 23: " + [ $40.constructor.name ]);
                  });
              });
          };
              ...
              var v = Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_List.traversableList)(Control_Apply.apply(Data_List.applyList)(Data_Functor.map(Data_List.functorList)(Data_Tuple.Tuple.create)(Data_List.range(0)(h - 1)))(Data_List.range(0)(w - 1)))(function (v) {
                  return function __do() {
                      ...
                      var t = (function () {
                          ...
                          throw new Error("Failed pattern match at Main line 57, column 17 - line 57, column 53: " + [ $50.constructor.name ]);
                      })();
                      return {
                          pieceType: t, 
      ...
      return function (board) {
          ...
          return Data_Functor["void"](Control_Monad_Eff.functorEff)(Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_List.traversableList)(board)(function (piece) {
              return Data_Functor["void"](Control_Monad_Eff.functorEff)((function () {
                  ...
                  throw new Error("Failed pattern match at Main line 125, column 9 - line 128, column 64: " + [ piece.pieceType.constructor.name ]);
              })());
          }));
      };
  };
  ...
  var main = Data_Function.apply(Data_Functor["void"](Control_Monad_Eff.functorEff))(Data_Function.apply(Partial_Unsafe.unsafePartial)(function (dictPartial) {
      return function __do() {
          ...
          return __unused(dictPartial)((function () {
              ...
              throw new Error("Failed pattern match at Main line 166, column 8 - line 195, column 27: " + [ v.constructor.name ]);
          })())();
      };
  }));
